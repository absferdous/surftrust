...
const ActionsMenu = ({
  ...
  const handleDuplicate = () => {
    if (!window.confirm("Are you sure you want to duplicate this notification?")) {
      return;
    }
    apiFetch({
      ...
      alert("Notification duplicated successfully! The new draft has been created.you can see it in the disabled tab");
  ...
  const handleDelete = () => {
    if (!window.confirm("Are you sure you want to move this notification to the trash?")) {
      return;
    }
    apiFetch({
  ...
  return /*#__PURE__*/React.createElement(Dropdown, {
    ...
    ,
    renderContent: () => /*#__PURE__*/React.createElement(MenuGroup, null, /*#__PURE__*/React.createElement(MenuItem, {
